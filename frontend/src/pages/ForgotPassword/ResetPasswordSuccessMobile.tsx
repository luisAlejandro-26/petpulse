...
function ResetPasswordSuccessMobile() {
    ...
    <div className="h-screen w-full bg-petpulse-bg flex justify-center overflow-hidden">
      ...
      <div className="h-full overflow-y-auto flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center">
          ...
          <h2 className="font-encode-expanded font-bold text-2xl text-petpulse-primary text-center mt-10 px-8 leading-snug">
            Recuperación exitosa, ya puedes iniciar sesión
          </h2>
          ...
          <div className="mt-10" role="status" aria-live="polite">
            <svg width="130" height="150" viewBox="0 0 130 150" fill="none">
              <path
                ...
                style={{
                  animation: 'draw-shield-reset 0.7s ease-out forwards',
                }}
              />
              <path
                ...
                strokeDashoffset="70"
                style={{
                  animation: 'draw-check-reset 0.4s ease-out forwards',
                  animationDelay: '0.6s',
                }}
              />
            </svg>
      ...
      <style>{`
        @keyframes draw-shield-reset {
          to { stroke-dashoffset: 0; }
        }
        @keyframes draw-check-reset {
          to { stroke-dashoffset: 0; }
        }
      `}</style>
    </div>
